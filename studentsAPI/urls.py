...
urlpatterns = [
    ...
    path('list/', views.students_list, name='students_list'),# display all students inserted so far
    path('statistics/', views.students_statistics, name='students_statistics') # get request to retrieve and display all statistics 
